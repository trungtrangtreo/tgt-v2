...
public class HeaderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HeaderAdapter(Context ctx, List<HashMap<String, String>> data, ItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            View v = mLayoutInflater.inflate(R.layout.place_item, parent, false);
            return new MyItem(v);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyItem) {
            ...
            ((MyItem) holder).mTitleView.setText(place.get("place_name"));
